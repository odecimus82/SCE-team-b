      ...
      <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
        <div className="space-y-8 lg:space-y-10 text-center lg:text-left order-2 lg:order-1">
          <div className="flex flex-col sm:flex-row items-center gap-4 justify-center lg:justify-start">
            <div className="inline-flex items-center gap-2 bg-sky-500 text-white px-4 py-2 rounded-full text-[10px] sm:text-xs font-black tracking-widest uppercase border-2 border-sky-600">
              SCE Team / 2026.01.10
            </div>
            {isDeadlinePassed ? (
          ...
          <div className="space-y-4">
            <h1 className="text-5xl sm:text-7xl lg:text-9xl font-black text-gray-900 leading-[0.9] tracking-tighter break-words">
              SCE TEAM<br />
              <span className="text-white bg-sky-500 px-3 py-1 inline-block transform -rotate-2 mt-2">DONGGUAN</span>
            </h1>
            <p className="text-lg sm:text-2xl font-bold text-gray-400 italic">Explore Huawei European Campus</p>
          </div>
          ...
          <div className="px-2 sm:px-0">
            <p className="text-base sm:text-xl text-gray-600 max-w-xl mx-auto lg:mx-0 font-medium leading-relaxed">
              SCE Team 2026 年度团建启程！我们将深入被各大媒体赞誉的华为 <span className="text-gray-900 font-bold italic underline decoration-sky-500 decoration-4">“溪流背坡村”</span>。
        ...
        <div className="relative group order-1 lg:order-2 px-4 sm:px-0 mb-8 lg:mb-0">
          ...
          <div className="relative aspect-[4/3] sm:aspect-[4/5] rounded-[2.5rem] lg:rounded-[4rem] overflow-hidden shadow-2xl border-4 sm:border-[12px] border-white transform hover:rotate-1 transition-transform duration-700">
            <img 
              ...
              onError={(e) => {
                (e.target as HTMLImageElement).src = 'https://via.placeholder.com/800x1000/111827/0EA5E9?text=SCE+Team+2026';
              }}
            />
